    ...
    <div className="bg-white min-h-screen">
      <div className="container w-full h-auto p-3 mx-auto">
        ...
        <div className="flex flex-col px-2 py-1 gap-y-2">
          <h1 className="text-md font-medium md:text-lg">
            Refunds and Chargebacks
          </h1>
          <div className="flex flex-col text-[10px] text-gray-600 md:text-xs">
            <p>
        ...
        <div className="bg-gray-300 p-1 rounded-lg h-12 ">
          <div className="flex items-center justify-between text-[10px] md:text-xs gap-x-3 h-full">
            <div
              className={`${
                selected === 1 ? "bg-white" : ""
        ...
        <div className="mt-3 rounded-lg overflow-hidden">
          <div className="p-5 sm:p-12 bg-gray-200 flex flex-col gap-3">
            <h1 className="text-center text-[10px] sm:text-sm">Preview</h1>
